...
The required C# projects depend on the architectural approach you choose:

#### Option 1: Monolithic MVC Architecture (Recommended for Regular Students)

The solution contains a single ASP.NET Core MVC application. All C# projects used in this solution must be included in the [TodoListApp.sln](TodoListApp.sln) solution file.

| Component                                                                                            | Template Name                                | Description                                                                                        |
|------------------------------------------------------------------------------------------------------|----------------------------------------------|----------------------------------------------------------------------------------------------------|
| [TodoListApp.WebApp](TodoListApp.WebApp/TodoListApp.WebApp.csproj)                                   | ASP.NET Core Web App (Model-View-Controller) | A web application that provides the browser UI and handles all business logic.                     |

The diagram below shows the dependencies of C# projects in the monolitic solution.

![Solution Design](images/solution-design-m.png)

#### Option 2: 3-Tier Architecture with Separate Web API (Advanced Students Only)

The solution contains two ASP.NET Core applications and additional class libraries for shared components. All C# projects used in this solution must be included in the [TodoListApp.sln](TodoListApp.sln) solution file.
...
The diagram below shows the dependencies of C# projects in the expected 3-tier solution.
...
**For Option 1 (Monolithic MVC Architecture):** The class diagram below is an example of using C# projects to store data classes (TodoList), service interfaces (ITodoListService), and service classes (TodoListDatabaseService).

![Class Diagram](images/class-diagram-services-m.png)

**For Option 2 (3-Tier Architecture):** The class diagram below is an example of using C# projects to store data classes (TodoList), service interfaces (ITodoListService), and service classes (TodoListWebApiService, TodoListDatabaseService).
